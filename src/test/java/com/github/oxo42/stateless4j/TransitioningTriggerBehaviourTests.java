...
public class TransitioningTriggerBehaviourTests {
    ...
    public void TransitionsToDestinationState() {
        TransitioningTriggerBehaviour<State, Trigger> transtioning = new TransitioningTriggerBehaviour<>(Trigger.X, State.C, toUntypedGuard(IgnoredTriggerBehaviourTests.returnTrue));
